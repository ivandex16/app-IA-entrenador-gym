...
import {
    LuUsers, LuDumbbell, LuListChecks, LuTarget, LuTrendingUp,
    LuShield, LuTrash2, LuSearch, LuCrown, LuActivity,
    LuCalendar, LuLoader,
} from 'react-icons/lu';
...
export default function AdminDashboard() {
    ...
    const handleDelete = async (userId, userName) => {
        if (!window.confirm(`¿Eliminar al usuario "${userName}" y todos sus datos? Esta acción es irreversible.`)) return;
        try {
    ...
    return (
        <div className="min-h-screen pb-12">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="absolute bottom-0 left-1/4 w-[350px] h-[200px] bg-purple-500/10 rounded-full blur-[100px]" />
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">
                                Panel de <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-purple-400">Administración</span>
                            </h1>
                            <p className="text-gray-400 text-sm">Gestión de usuarios y estadísticas de la plataforma</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                {stats && (
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 animate-fadeInUp">
                        {[
                            ...
                            { label: 'Rutinas', value: stats.totalRoutines, icon: LuListChecks, color: 'from-purple-500 to-fuchsia-600', sub: 'creadas' },
                            { label: 'Ejercicios', value: stats.totalExercises, icon: LuDumbbell, color: 'from-amber-500 to-orange-600', sub: 'en catálogo' },
                        ].map((s) => (
